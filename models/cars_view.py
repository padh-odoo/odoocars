...
class car_feature(models.Model):
    ...
    selling_price=fields.Integer("Selling Price",tracking=True,default=500000)
    ...
    registration_number=fields.Char("Registration Number",default="UP 65 AT 5376")
    chassis_number=fields.Char("Chassis Number",default="2138675543321")
    ...
    @api.depends('fuel_id','selling_price','gst','offer_id','wrap','wraping')
